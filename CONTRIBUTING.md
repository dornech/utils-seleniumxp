...
Welcome to the contributor guide of SeleniumXP utilities for Python.
...
If you experience bugs or general issues with SeleniumXP utilities for Python, please have a look
...
You can help improve the documentation of SeleniumXP utilities for Python by making them more readable
...
3. Clone this copy to your local disk:
   ...
   ```console
   git clone git@github.com:YourLogin/utils-seleniumxp.git
   cd utils-seleniumxp
   ```
