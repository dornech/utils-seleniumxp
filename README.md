...
Different from other packages extending the Selenium webdriver class this package does not work with
...
The webelement extensions are done via setattr only. Implementing a mixin class would require
